...
namespace MongoDB.Usermanager.Context
{
    public class MongoContext
    {
        ...
        /// <summary>
        /// Use this to set a database name
        /// </summary>
        /// <param name="databaseName">The name of a database</param>
        ...
        /// <summary>
        /// Establishes a MongoClient with a given connection string
        /// </summary>
        /// <param name="connection">The connection string to a mongo cluster</param>
        ...
        /// <summary>
        /// Takes a username and password in string format and handles everything from there including encryption
        /// </summary>
        /// <param name="username"></param>
        /// <param name="password"></param>
        /// <param name="pepper"></param>
        /// <returns></returns>
        public async Task<bool> AddNewUserAsync(string username, string password)
        {
        ...
        /// <summary>
        /// Takes a username and password in string format and attempts to get from authentication database, handles all encryption
        /// </summary>
        /// <param name="username"></param>
        /// <param name="password"></param>
        /// <returns>Returns the object id of a user match, or ObjectId.empty if no user matched the credentials</returns>
